...
namespace Md.Persistentce.Migrations
{
    ...
    [Migration("20220414172310_ProductRecord_Create")]
    partial class ProductRecord_Create
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Md.Domain.Entities.Meal.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Md.Domain.Entities.Meal.Meal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Md.Domain.Entities.Meal.Meal", b =>
                {
                    b.HasOne("Md.Domain.Entities.Meal.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("Md.Domain.Entities.Order.OrderProduct", b =>
                {
                    ...
                    b.HasOne("Md.Domain.Entities.Order.Order", "Order")
                        .WithMany()
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Md.Domain.Entities.Products.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Md.Domain.Entities.Products.Product", b =>
                {
                    ...
                    b.HasOne("Md.Domain.Entities.Meal.Meal", null)
                        .WithMany("Products")
